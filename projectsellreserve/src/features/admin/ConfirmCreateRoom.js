...
import { confirmedCreateRoom } from "../../apis/admin-api";
...
export default function ConfirmCreateRoom() {
  ...
  const handleConfirmedCreateRoom = async id => {
    try {
      startLoading();
      console.log("id:", id);
      console.log("type of id:", typeof id);
      if (id !== undefined) {
        await confirmedCreateRoom(id);
        stopLoading();
      } else {
            ...
            <div key={el.id} className="flex flex-col justify-center gap-2">
              ...
              <div className="border-2 rounded-tl-2xl rounded-tr-2xl">
                ...
                <div className="text-[14px] max-w-[280px] flex flex-grow flex-col justify-center items-center p-2">
                  <p>
                    createRoomDataId :{" "}
                    <span className="font-bold text-[18px]">{el.id}</span>{" "}
                  </p>
                ...
                <div className="flex justify-center items-center gap-6">
                  <button
                    ...
                    onClick={() => handleConfirmedCreateRoom(el.id)}
                  >
                    ConfirmedCreate
                  </button>
